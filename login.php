...
<div class="auth-layout">
    <section class="auth-showcase" aria-label="<?= e(t('auth.intro_label')) ?>">
        ...
        <div class="auth-story">
            ...
            <p class="auth-story-title"><?= e(t('auth.login.headline_before')) ?> <span><?= e(t('auth.login.headline_emphasis')) ?></span></p>
            <p><?= e(t('auth.login.story')) ?></p>
            <div class="auth-points"><span class="auth-point"><i aria-hidden="true" class="bi bi-camera-video"></i> <?= e(t('auth.login.point_ai')) ?></span><span class="auth-point"><i aria-hidden="true" class="bi bi-lightning-charge"></i> <?= e(t('auth.login.point_quiz')) ?></span><span class="auth-point"><i aria-hidden="true" class="bi bi-trophy"></i> <?= e(t('auth.login.point_board')) ?></span></div>
        </div>
    ...
    <section class="auth-panel">
        <div class="auth-form-wrap">
            ...
            <span class="eyebrow"><?= e(t('auth.login.welcome')) ?></span><h1><?= e(t('auth.login.heading')) ?></h1><p><?= e(t('auth.login.subheading')) ?></p>
            ...
            <div class="auth-trust"><i aria-hidden="true" class="bi bi-shield-check"></i> <?= e(t('auth.trust_password')) ?></div>
        </div>
    </section>
</div>
