...
<header class="app-header" id="appHeader">
    <div class="container-wide header-inner">
        <a class="brand" href="<?= e($basePath) ?>index.php" aria-label="<?= e(t('nav.brand_home')) ?>">
            <span class="brand-mark" aria-hidden="true"><svg viewBox="0 0 42 42" role="img"><path d="M12.5 21.5v-8a2.5 2.5 0 0 1 5 0v5-9a2.5 2.5 0 0 1 5 0v9-7a2.5 2.5 0 0 1 5 0v8-4.5a2.5 2.5 0 0 1 5 0V24c0 8-4.6 12-11.2 12-5.8 0-9.6-3.1-12.6-8l-2.2-3.7a2.7 2.7 0 0 1 4.3-3.2l1.7 1.4Z"/></svg></span>
        ...
        <nav class="primary-nav" id="primaryNav" aria-label="<?= e(t('nav.primary')) ?>">
            <a class="nav-link-custom <?= $activePage === 'home' ? 'active' : '' ?>" href="<?= e($basePath) ?>index.php"><i class="bi bi-grid"></i><span><?= e(t('nav.home')) ?></span></a>
            <a class="nav-link-custom <?= $activePage === 'learn' ? 'active' : '' ?>" href="<?= e($basePath) ?>pages/learn.php"><i class="bi bi-journal-richtext"></i><span><?= e(t('nav.learn')) ?></span></a>
            <a class="nav-link-custom <?= $activePage === 'practice' ? 'active' : '' ?>" href="<?= e($basePath) ?>pages/ai_tracking.php"><i class="bi bi-camera-video"></i><span><?= e(t('nav.ai')) ?></span></a>
            <a class="nav-link-custom <?= $activePage === 'quiz' ? 'active' : '' ?>" href="<?= e($basePath) ?>pages/quiz.php"><i class="bi bi-lightning-charge"></i><span><?= e(t('nav.quiz')) ?></span></a>
            <a class="nav-link-custom <?= $activePage === 'leaderboard' ? 'active' : '' ?>" href="<?= e($basePath) ?>pages/leaderboard.php"><i class="bi bi-trophy"></i><span><?= e(t('nav.ranking')) ?></span></a>
        </nav>
        ...
        <div class="profile-menu">
            ...
            <a class="logout-link" href="<?= e($basePath) ?>logout.php" title="<?= e(t('nav.logout')) ?>" aria-label="<?= e(t('nav.logout')) ?>"><i class="bi bi-box-arrow-right"></i></a>
        </div>
    </div>
</header>
...
<div class="toast-notice toast-<?= e($flash['type'] ?? 'info') ?>" role="status" aria-live="polite">
    <i class="bi bi-info-circle-fill"></i><span><?= e(flashMessage($flash)) ?></span>
    <button type="button" aria-label="<?= e(t('common.close_notice')) ?>"><i class="bi bi-x-lg"></i></button>
</div>
<?php endif; ?>
