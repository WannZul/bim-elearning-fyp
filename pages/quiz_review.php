...
<div class="page-shell review-page">
    <div class="container-wide">
        <header class="review-summary surface-card" data-reveal>
            ...
            <div class="review-summary-actions"><a class="btn-primary-custom" href="quiz.php?theme=<?= urlencode($result['theme_key']) ?>"><i class="bi bi-arrow-repeat"></i> Cuba lagi</a><a class="btn-light-custom" href="leaderboard.php?type=<?= urlencode($result['theme_key']) ?>"><i class="bi bi-trophy"></i> Lihat ranking <?= e($result['theme_title']) ?></a></div>
        </header>
